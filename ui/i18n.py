...
TRANSLATIONS: dict[str, dict[str, str]] = {
    ...
    "hero_badge": {"vi": "Trợ lý nghiên cứu AI", "en": "AI Research Assistant"},
    "hero_chip_search": {"vi": "🔍 Tìm web", "en": "🔍 Web search"},
    "hero_chip_read": {"vi": "📖 Đọc nguồn", "en": "📖 Reads sources"},
    "hero_chip_cite": {"vi": "🔖 Trích dẫn", "en": "🔖 Cited report"},
    "hero_chip_multi": {"vi": "🤖 Đa agent", "en": "🤖 Multi-agent"},
